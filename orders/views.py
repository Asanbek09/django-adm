...
class ExportAPIView(APIView):
    ...
    def get(self, request):
        ...
        response['Content-Dispositions'] = 'attachment; filename=orders.csv'
...
class ChartAPIView(APIView):
    ...
    def get(self, _):
        with connection.cursor() as cursor:
            cursor.execute("""
            SELECT to_char(o.created_at, 'DD/MM/YYYY') as date, sum(i.quantity * i.price) as sum FROM orders_order as o 
